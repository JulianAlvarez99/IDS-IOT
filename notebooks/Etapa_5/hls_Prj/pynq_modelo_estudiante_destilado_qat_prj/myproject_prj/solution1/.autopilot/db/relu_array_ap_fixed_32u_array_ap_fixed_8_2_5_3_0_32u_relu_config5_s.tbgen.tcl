set moduleName relu_array_ap_fixed_32u_array_ap_fixed_8_2_5_3_0_32u_relu_config5_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {relu<array<ap_fixed,32u>,array<ap_fixed<8,2,5,3,0>,32u>,relu_config5>}
...
set Spec2ImplPortList { 
	layer4_out { ap_fifo {  { layer4_out_dout fifo_port_we 0 256 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer4_out_fifo_cap fifo_update 0 2 }  { layer4_out_empty_n fifo_status 0 1 }  { layer4_out_read fifo_data 1 1 } } }
	layer5_out { ap_fifo {  { layer5_out_din fifo_port_we 1 256 }  { layer5_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer5_out_fifo_cap fifo_update 0 2 }  { layer5_out_full_n fifo_status 0 1 }  { layer5_out_write fifo_data 1 1 } } }
}
