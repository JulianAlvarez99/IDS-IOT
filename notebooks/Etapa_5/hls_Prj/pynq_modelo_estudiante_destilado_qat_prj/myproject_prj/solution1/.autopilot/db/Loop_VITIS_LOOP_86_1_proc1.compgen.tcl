...
set name inference_fpext_32ns_64_3_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fpext} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


set id 2
set name inference_ashr_54ns_32ns_54_2_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { features_in_data_V_din { O 8 vector } features_in_data_V_num_data_valid { I 6 vector } features_in_data_V_fifo_cap { I 6 vector } features_in_data_V_full_n { I 1 bit } features_in_data_V_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 13
set RegSliceName inference_regslice_both
set RegSliceInstName inference_regslice_both_U
set CoreName ap_simcore_inference_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set InstName inference_flow_control_loop_pipe_U
set CompName inference_flow_control_loop_pipe
