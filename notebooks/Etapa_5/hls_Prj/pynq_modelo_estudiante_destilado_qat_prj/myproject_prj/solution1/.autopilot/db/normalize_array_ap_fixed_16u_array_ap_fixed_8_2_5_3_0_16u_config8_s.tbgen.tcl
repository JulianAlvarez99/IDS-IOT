set moduleName normalize_array_ap_fixed_16u_array_ap_fixed_8_2_5_3_0_16u_config8_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {normalize<array<ap_fixed,16u>,array<ap_fixed<8,2,5,3,0>,16u>,config8>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer6_out int 128 regular {fifo 0 volatile }  }
	{ layer8_out int 128 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "layer6_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8s_8ns_14_1_1_U66", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_port_we 0 128 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer6_out_fifo_cap fifo_update 0 2 }  { layer6_out_empty_n fifo_status 0 1 }  { layer6_out_read fifo_data 1 1 } } }
	layer8_out { ap_fifo {  { layer8_out_din fifo_port_we 1 128 }  { layer8_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer8_out_fifo_cap fifo_update 0 2 }  { layer8_out_full_n fifo_status 0 1 }  { layer8_out_write fifo_data 1 1 } } }
}
